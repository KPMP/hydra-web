        ...
        let columns = [
            ...
            },  
            {
                ...
                getCellValue: row => { 
                    ...
                    ? <button onClick={(e) => this.props.props.history.push('/report')} type='button' data-toggle="tooltip" data-placement="top" title="View participant information" className='table-column btn btn-link text-left p-0'>{row["redcap_id"]}</button>
                    : row["redcap_id"]
                } 
            }, 
            {
